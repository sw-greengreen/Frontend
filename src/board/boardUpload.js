...
function BoardUpload() {
  ...
  const [post, setPost] = new useState({"username":window.localStorage.getItem("username"), "title":"", "content":"", "photo" : "", "hashtag":"", "postType":"LOST", "resolvingStatus":"WAITING", "isAnontymous":""})
